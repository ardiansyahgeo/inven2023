...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_BATASKAMPUNGPRIORITASINVEN2023_16,
      colName: 'KAMPUNG_AL',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([11882312.095333, -689306.615941, 11886663.334273, -686885.403858], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        var qgis2webAttribution = document.createElement('li');
         qgis2webAttribution.innerHTML = '<a href="https://drive.google.com/drive/folders/1xwbFjIB1Z1ndjeO9UPbgNCEzUlL7UbmG?usp=share_link">BASISDATA</a> &middot; ';
        ...
        qgisAttribution.innerHTML = '<a href="https://drive.google.com/file/d/1s3qI2-4YNUQDvM1LPOnFW3UDRjX_5Ldh/view?usp=sharing">KEPGUB 979</a>';
